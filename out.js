...
var check_required = function check_required(required, given, name) {
  required = required || [];
  given = given || {};
...
var get_arg_fields = function get_arg_fields(arg_fields, args) {
  ...
  try {
    for (var _iterator2 = arg_fields[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var arg_field = _step2.value;
...
var constructor = function constructor(const_opts) {
...
},{"./constructor":2}],300:[function(require,module,exports){
'use strict';
...
},{"./renderer":299,"babel-polyfill":3}]},{},[300]);
